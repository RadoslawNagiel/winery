...
export const PRODUC_STAGES_DESCRIPTIONS: ProductStageDescription[] = [
  ...
  },
  {
    ...
    descriptions: [
      ...
      `Wino zlewamy znad osadu. Następnie próbujemy i dosładzamy według uznania. Możemy wspierać się poradnikiem dotyczącym słodkości wina, ale należy uważać, żeby nie przesadzić z cukrem. Po dosłodzeniu ponownie próbujemy i sprawdzamy czy osiągnęliśmy oczekiwaną słodkość. Wino nie powinno już pracować, więc możemy je szczelnie zamknąć (bez rurki fermentacyjnej). Uwaga! Należy sprawdzić po kilku dniach, czy wino nie wznowiło pracy. Zadziać się tak może, kiedy nie osiągnęliśmy jeszcze alkoholu równego tolerancji drożdży. Jeśli tak będzie, należy gąsior znowu zatkać z użyciem rurki fermentacyjnej i cofnąć wykonanie tego etapu.`,
      `Wino zlewamy znad osadu. Następnie należy pozbyć się pozostałych drożdży, aby po dosłodzeniu nie był już wytwarzany alkohol. Proces ten został opisany w poradniku ‘Zatrzymanie fermentacji’. Następnie próbujemy wino i dosładzamy według uznania. Możemy wspierać się poradnikiem dotyczącym słodkości wina, ale należy uważać, żeby nie przesadzić z cukrem. Po dosłodzeniu ponownie próbujemy i sprawdzamy czy osiągnęliśmy oczekiwaną słodkość. Wino nie powinno już pracować, więc możemy je szczelnie zamknąć (bez rurki fermentacyjnej). Uwaga! Należy sprawdzić po kilku dniach, czy wino nie wznowiło pracy. Jeśli tak się zadzieje, oznacza to, że proces pozbycia się drożdży nie udał się i należy go powtórzyć.`,
    ],
    guides: [
      {
        name: `Fermentacja`,
